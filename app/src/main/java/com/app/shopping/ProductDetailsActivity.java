        ...
        productsRef.child(productID).addValueEventListener(new ValueEventListener() {
                                              ...
                                              public void onDataChange(DataSnapshot dataSnapshot) {
                                                  if (dataSnapshot.exists()) {
                                                      ...
                                                      Log.d("productDescription", "onDataChange: "+ products.getCategory());
                                                      Log.d("productDescription", "onDataChange: "+ products.getImage());
                                                      Log.d("productDescription", "onDataChange: "+ productID);
                                                      String imageProduct = products.getImage();
                                                      cartMap.put("image",imageProduct);
...
//        cartMap.put("image",productName.getText().toString());
//                Log.d("ProductDetailsActivity", "addingToCartList: " + productName.getText().toString());
